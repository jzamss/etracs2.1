...
Host - 5.0.27-community-nt-log : Database - alegria_system
*********************************************************************
...
insert  into `rule_package`(`ruleset`,`rulegroup`,`packagename`,`orderindex`,`type`,`content`,`lastmodified`) values ('rptbilling','','etracs2.rpt.billing.facts',0,'facts','package etracs2.rpt.billing.facts;\r\n\r\ndeclare CurrentYearFact\r\n        factname  : String\r\n	year  : Integer\r\n	qtr   : Integer\r\n	month : Integer\r\n	day   : Integer\r\nend\r\n\r\ndeclare RPTLedgerFact\r\n    rptledgerid             : String\r\n    factname                : String\r\n    firstitem               : Boolean\r\n    ledgerid                : String\r\n    rulename                : String\r\n    tdno                    : String \r\n    year                    : Integer\r\n    qtr                     : Integer \r\n    assessedvalue           : Double\r\n    txntype                 : String \r\n    rputype                 : String \r\n    classid                 : String\r\n    actualuseid             : String\r\n    numberofmonthsfromqtr   : Integer\r\n    numberofmonthsfromjan   : Integer\r\n    firstqtrpaidontime      : Boolean\r\n    qtrlypaymentavailed     : Boolean\r\n    backtax                 : Boolean \r\n    fullpayment             : Boolean \r\n    advancepayment          : Boolean \r\n    lastyearpaid            : Integer\r\n    lastqtrpaid             : Integer \r\n\r\n    revtype                 : String\r\n    basic                   : Double\r\n    basicint 	            : Double\r\n    basicdisc   	    : Double\r\n    sef                     : Double\r\n    sefint                  : Double\r\n    sefdisc                 : Double\r\n    \r\n    basicacctid             : String \r\n    basicintacctid          : String \r\n    sefacctid               : String \r\n    sefintacctid            : String \r\n\r\n    partialbasic            : Double\r\n    partialsef              : Double	\r\n\r\n    varlist                 : java.util.Map\r\n    expr                    : String \r\nend     \r\n\r\n',NULL);
...
insert  into `sys_cluster_host`(`name`,`context`,`host`) values ('server1','alegria','169.254.64.62:8080');
...
insert  into `sys_roleclass`(`name`,`description`,`rolelevel`,`tags`) values ('RPT','RPT ASSESSMENT',1,NULL);
...
insert  into `sys_session`(`sessionid`,`username`,`host`,`dtaccessed`) values ('server1:54a3c372:136b501296e:-7ffe','taskscheduler','server1','2012-04-15 15:57:34');
...
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('assessor_name',NULL,NULL,NULL,'RPT');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('assessor_officename',NULL,NULL,NULL,'RPT');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('assessor_title',NULL,NULL,NULL,'RPT');
...
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('collecting_agency',NULL,NULL,NULL,'TREASURY');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('deposit_print_date','0',NULL,NULL,'SYSTEM');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('faas_attachment_path','D:/temp/faasattachments',NULL,NULL,'SYSTEM');
...
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('lgu_address','BOHOL',NULL,NULL,'LGU');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('lgu_formal_name','CITY OF TAGBILARAN CITY',NULL,NULL,'LGU');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('lgu_index','001',NULL,NULL,'LGU');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('lgu_name','TAGBILARAN CITY','lgu name',NULL,'LGU');
...
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('mayor_name','JESS ZAMORA',NULL,NULL,'LGU');
...
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('parent_lgu_formal_name',NULL,NULL,NULL,'LGU');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('parent_lgu_name',NULL,'Parent LGU Name',NULL,'LGU');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('pin_autonumber','0',NULL,NULL,'SYSTEM');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('pin_parcel_length',NULL,'The number of digits in pin parcel.',NULL,'RPT');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('pin_section_length',NULL,'The number of digits in pin section.',NULL,'RPT');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('pin_type',NULL,'PIN Formatting Type valid values: old or new',NULL,'RPT');
...
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('server_address','10.0.0.154:8080',NULL,NULL,NULL);
...
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('system_pwd','!12345','system password',NULL,'SYSTEM');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('td_autonumber','1',NULL,NULL,'SYSTEM');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('td_format','Y-M-B','Tax Declaration No. format. Options: Y- revision year, M-municipality index, C - city index, D-district index, B=-barangay index',NULL,'SYSTEM');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('td_report_display_appraisedby','1',NULL,NULL,'SYSTEM');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('td_report_item_format','BLGF',NULL,NULL,'SYSTEM');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('td_show_landinfo_on_improvements','1','Show the land information such as boundary etc in the improvement tax declaration. Options: 1 - show; 0 - hide',NULL,'SYSTEM');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('treasurer_name',NULL,NULL,NULL,'TREASURY');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('treasurer_title',NULL,NULL,NULL,'TREASURY');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('treasury_officename',NULL,NULL,NULL,'TREASURY');
insert  into `sys_var`(`name`,`value`,`description`,`datatype`,`category`) values ('url_logo_lgu','http://localhost:8080/downloads/images/lgu.png','logo path','image','LGU');
